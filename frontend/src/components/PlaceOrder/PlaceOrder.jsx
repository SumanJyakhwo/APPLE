...
<input type="email" placeholder='Email Address' /><input type="text"  placeholder='Street'/>
      ...
      <div className="multi-fields"><input type="text" placeholder="City" /><input type="text" placeholder="State" /></div>
      <div className="multi-fields"><input type="text" placeholder="Zip Code" /><input type="text" placeholder="Country" /></div>
     ...
     <div className="place-order-right"><div className="cart-total">
          ...
          <button onClick={() => navigate('/payment')}>Proceed To Payment Page</button>
        </div></div>
